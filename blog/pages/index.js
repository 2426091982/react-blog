...
const Home = (res) => {
  ...
  return (
    <>
      ...
      <Head>
        <title>首页 | 郑嘉俊的个人博客-前端学习博客分享</title>
        <meta name="description" content="首页 | 郑嘉俊的个人博客-前端学习博客分享"></meta>
      ...
      <Row className="comm-main" type="flex" justify="center">
        <Col xs={24} sm={24} md={18}  >
                ...
                <List.Item>
                  <Spin spinning={loading}>
                    ...
                    <div className="list-icon">
                      <span><Tag color="blue">置顶</Tag></span>
                    ...
                    <div className="list-go">
                      <Icon type="file" /> &nbsp;
                      <span className='view-all' onClick={goLoading}>
                        <Link href={{ pathname: '/detailed', query: { id: item.id } }} >
                          <a>查看全文 </a>
                        </Link>
                      </span>
                ...
                <List
                  header={
                    <div className="bibidao-title">
                      <div className="list-header left">推荐学习的视频</div>
          ...
          <div className="comm-left">
            ...
            <List
              header={<div className="list-header">最新发布</div>}
              itemLayout="vertical"
              dataSource={mylist}
              renderItem={item => (
                <List.Item>
